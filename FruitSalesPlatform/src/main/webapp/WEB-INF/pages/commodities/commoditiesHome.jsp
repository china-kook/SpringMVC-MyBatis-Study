...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteCommodities(id, name) {
            if (window.confirm("你确定要删除商品「" + name + "」吗？")) {
...
<div class="addMask">
    <div class="c">
        <div style="background-color:#173e65;height:20px;color:#fff;font-size:12px;padding-left:7px;">
            添加信息<font style="float:right;padding-right: 10px;"
...
<form id="listForm" action="list.action" method="post">
    ...
    价格：<input id="price1" name="startPrice" type="number" min="0.0" step="0.1" style="width:60px"
              value="${startPrice}"/>
    - <input id="price2" name="endPrice" type="number" min="0.0" step="0.1" style="width:60px"
             value="${endPrice}"/><br/><br/>
    创建日期：<input type="datetime-local" name="startTime" value="${startTime}"/> - <input
        type="datetime-local" name="endTime" value="${endTime}"/>
